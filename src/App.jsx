...
/* ============================================================
   ...
   ============================================================ */
// 名單頁能選的位置。「自由」已改用每位球員的 libero 開關指定，這裡不再列出，
...
const DEFAULT_ANCHORS = {
  // 使用者的慣用陣型（實際拉點校準）
  // 接發分三種人數：R5＝5人接發、R4＝4人接發、R3＝3人接發；
  // 每種人數再依舉球站的號位分 P1–P6（P1／P5／P6 是舉球在後排，砲中背(雙) 與單舉會用到）
  recv: {
    R5: { // 5 人接發
      P1: { 1: [0.947, 0.561], 2: [0.85, 0.454], 3: [0.513, 0.257], 4: [0.104, 0.442], 5: [0.293, 0.787], 6: [0.709, 0.795] },
      P2: { 1: [0.746, 0.816], 2: [0.906, 0.115], 3: [0.828, 0.413], 4: [0.168, 0.407], 5: [0.297, 0.816], 6: [0.503, 0.616] },
      P3: { 1: [0.787, 0.844], 2: [0.837, 0.368], 3: [0.595, 0.127], 4: [0.189, 0.373], 5: [0.248, 0.821], 6: [0.525, 0.625] },
      P4: { 1: [0.798, 0.816], 2: [0.847, 0.356], 3: [0.188, 0.394], 4: [0.075, 0.093], 5: [0.266, 0.81], 6: [0.523, 0.643] },
      P5: { 1: [0.757, 0.804], 2: [0.843, 0.43], 3: [0.191, 0.437], 4: [0.088, 0.105], 5: [0.04, 0.207], 6: [0.359, 0.812] },
      P6: { 1: [0.691, 0.77], 2: [0.84, 0.467], 3: [0.5, 0.06], 4: [0.174, 0.469], 5: [0.361, 0.779], 6: [0.5, 0.2] },
    },
    R4: { // 4 人接發（不接的兩位拉到網前）
      P1: { 1: [0.96, 0.592], 2: [0.859, 0.513], 3: [0.505, 0.165], 4: [0.168, 0.5], 5: [0.322, 0.766], 6: [0.645, 0.8] },
      P2: { 1: [0.675, 0.746], 2: [0.906, 0.115], 3: [0.825, 0.458], 4: [0.086, 0.079], 5: [0.187, 0.462], 6: [0.341, 0.763] },
      P3: { 1: [0.837, 0.504], 2: [0.67, 0.236], 3: [0.595, 0.127], 4: [0.19, 0.498], 5: [0.353, 0.762], 6: [0.688, 0.749] },
      P4: { 1: [0.772, 0.769], 2: [0.824, 0.438], 3: [0.157, 0.102], 4: [0.052, 0.239], 5: [0.208, 0.577], 6: [0.413, 0.832] },
      P5: { 1: [0.73, 0.779], 2: [0.817, 0.484], 3: [0.214, 0.482], 4: [0.118, 0.084], 5: [0.079, 0.233], 6: [0.398, 0.807] },
      P6: { 1: [0.718, 0.745], 2: [0.859, 0.422], 3: [0.5, 0.06], 4: [0.138, 0.444], 5: [0.36, 0.777], 6: [0.5, 0.2] },
    },
    R3: { // 3 人接發：舉球與副攻已拉開不接，第三個不接的人由使用者自行拖走
      P1: { 1: [0.902, 0.698], 2: [0.797, 0.547], 3: [0.477, 0.15], 4: [0.172, 0.144], 5: [0.191, 0.642], 6: [0.523, 0.762] },
      P2: { 1: [0.88, 0.584], 2: [0.885, 0.135], 3: [0.169, 0.642], 4: [0.051, 0.129], 5: [0.348, 0.93], 6: [0.522, 0.665] },
      P3: { 1: [0.862, 0.652], 2: [0.594, 0.224], 3: [0.499, 0.112], 4: [0.182, 0.575], 5: [0.535, 0.716], 6: [0.714, 0.93] },
      P4: { 1: [0.957, 0.814], 2: [0.188, 0.596], 3: [0.109, 0.256], 4: [0.075, 0.078], 5: [0.508, 0.713], 6: [0.84, 0.658] },
      P5: { 1: [0.82, 0.7], 2: [0.865, 0.162], 3: [0.2, 0.652], 4: [0.135, 0.113], 5: [0.046, 0.242], 6: [0.5, 0.8] },
      P6: { 1: [0.834, 0.636], 2: [0.775, 0.227], 3: [0.563, 0.101], 4: [0.169, 0.581], 5: [0.486, 0.713], 6: [0.566, 0.233] },
    },
  },
  /* 防守：模式 → 套別 → 對方攻擊方向。每個模式各存一份，
     改其中一個模式的點不會動到別的模式（哪個模式用哪幾套見 MODE_VARIANTS）。 */
  def: {
    "砲中(雙)": {
      // M＝砲中：砲(左) 中(中) 舉(右)
      M: {
        L: { FL: [0.174, 0.075], FC: [0.314, 0.291], FR: [0.805, 0.33], BL: [0.171, 0.841], BC: [0.475, 0.798], BR: [0.703, 0.656] },
        C: { FL: [0.285, 0.342], FC: [0.509, 0.127], FR: [0.762, 0.33], BL: [0.235, 0.708], BC: [0.5, 0.88], BR: [0.786, 0.687] },
        R: { FL: [0.168, 0.364], FC: [0.781, 0.097], FR: [0.635, 0.337], BL: [0.303, 0.641], BC: [0.568, 0.816], BR: [0.869, 0.844] },
      },
    },
    "砲背(雙)": {
      // A＝砲背：砲(左) 舉(中) 背(右)
      A: {
        L: { FL: [0.216, 0.075], FC: [0.364, 0.325], FR: [0.826, 0.348], BL: [0.171, 0.841], BC: [0.475, 0.798], BR: [0.703, 0.656] },
        C: { FL: [0.285, 0.342], FC: [0.503, 0.154], FR: [0.725, 0.339], BL: [0.235, 0.708], BC: [0.5, 0.88], BR: [0.786, 0.687] },
        R: { FL: [0.168, 0.364], FC: [0.633, 0.325], FR: [0.807, 0.076], BL: [0.303, 0.641], BC: [0.568, 0.816], BR: [0.869, 0.844] },
      },
    },
    "砲中背(雙)": {
      // B＝砲中背：砲(左) 中(中) 背(右)
      B: {
        ...
        R: { FL: [0.168, 0.364], FC: [0.64, 0.075], FR: [0.854, 0.06], BL: [0.303, 0.641], BC: [0.568, 0.816], BR: [0.869, 0.844] },  // FC 為避開 FR 重疊而外移：預設值，待使用者校準
      },
    },
    "單舉": {
      // M＝砲中：砲(左) 中(中) 舉(右)
...
const effRole = (e, pos, mode) =>
  (!e ? null
    : mode === MODE_B2 && e.role === "舉球" && FRONT.includes(pos) ? "副攻"
      : e.role);
// 前排沒有舉球 →「砲中背」；前排有副攻 →「砲背」；其餘 →「砲中」
const frontVariant = (occ, mode) =>
  !FRONT.some((p) => effRole(occ[p], p, mode) === "舉球") ? "B"
    : FRONT.some((p) => effRole(occ[p], p, mode) === "副攻") ? "A" : "M";
...
/* 後排防守位置有三種模式：
   def    預設   ── 依隊伍模式查 MODE_BACK_ROLE（沒選模式時用 DEFAULT_BACK_ROLE）
   none   不指定 ── 全部依基本輪轉順序
   custom 特     ── 逐人指定，撞格的輪次由使用者用 pri 排除
   pri：{ "輪次:格子": 球員id } */
// 沒選過模式時的後備表（也留著給舊資料裡的「自由」位置）
...
const backWant = (e, pos, serve, mode, teamMode) => {
  if (!e || mode === "none") return null;
  if (mode === "custom") return e.back || null;
  if (e.libero && !(serve && pos === 1)) return LIBERO_BACK; // 這一格其實是自由球員
  return backRoleTable(teamMode)[effRole(e, pos, teamMode)] || null;
};

// 「預設」那段說明文字，跟著模式走（沒選模式就照後備表講）
const backRuleText = (teamMode) =>
  Object.keys(backRoleTable(teamMode))
    .filter((r) => r !== "自由")
    .map((r) => `${r}${PIN_NAME[backRoleTable(teamMode)[r]]}`)
    .join("・") + `・自由球員${PIN_NAME[LIBERO_BACK]}`;

function backOrder(occ, r, pri, mode, serve, ovBack, teamMode) {
  ...
  const done = new Set();
  // 每一格有幾個人想守
  const wantOf = players.map((pl) => backWant(pl.e, pl.pos, serve, mode, teamMode));
  const wantCount = {};
...
function backConflicts(lineup, mode, teamMode) {
  const out = [];
  for (let r = 0; r < 6; r++) {
    ...
    BACK.forEach((p) => {
      const e = occ[p];
      const k = backWant(e, p, false, mode, teamMode);
...
function frontByRole(occ, set, mode) {
  const roles = FRONT.map((p) => effRole(occ[p], p, mode));
  ...
  let slotFor;
  if (n("舉球") === 1 && n("副攻") === 1) slotFor = (rl) => (rl === "副攻" ? "FR" : rl === "舉球" ? "FC" : "FL");
  else if (n("舉球") === 1 && n("攔中") === 1) slotFor = (rl) => (rl === "舉球" ? "FR" : rl === "攔中" ? "FC" : "FL");
  else if (n("攔中") === 1 && n("副攻") === 1) slotFor = (rl) => (rl === "副攻" ? "FR" : rl === "攔中" ? "FC" : "FL");
  else return { err: "前排角色組合不符" };
  return {
    spots: FRONT.map((p, i) => {
      const k = slotFor(roles[i]);
...
function formation(lineup, r, sceneId, A, recvMode, pri, backMode, weServe, ovBack, teamMode) {
  ...
  const spots = [...f.spots];
  backOrder(occ, r, pri, backMode, keepServer, ovBack, teamMode).forEach((b, i) => {
    const k = ["BL", "BC", "BR"][i];
...
// blockMiss 已無對應按鈕，只留標籤給舊資料看，不列進儀表板
const LOSE_ENDS = ["serveMiss", "recvMiss", "defMiss", "atkMiss", "blockOut", "netTouch", "overLine"];
// 這些結束原因沒有對應的記號，不去猜是誰
...
function statsOf(rallies) {
  ...
  const touches = rallies.reduce((a, ra) => a + (ra.touched || 0), 0);
  return { causes, byRot, dir, trend, touches, total: rallies.length, us, them };
}
...
function blameOf(rallies, end) {
  ...
  rallies.forEach((ra, i) => {
    ...
    const key = id || "__none";
    (tally[key] = tally[key] || []).push({
      i, us, them, rot: ra.rot, at: ra.at, base: ra._base, setIdx: ra._set, ri: ra._ri,
    });
  });
...
const SCENES = [
  { id: "serve", label: "發球" },
  { id: "recv", label: "接發" },
  { id: "d3", label: "副攻攻擊", ball: true }, // DEF_MAP.d3 = L（對方從我方左側來）
...
const MIGRATIONS = {
  ...
  // v14 → v15：定點與接發人數改成每隊一份。
  // 順序很重要：先把原本的全域座標複製給每一支隊伍，複製完才拿掉頂層欄位。
  14: (d) => ({
    ...d,
    teams: (d.teams || []).map((t) => ({
      ...t,
      anchors: t.anchors || (d.anchors ? normalizeAnchors(d.anchors) : normalizeAnchors({})),
      recvMode: t.recvMode || d.recvMode || "R5",
    })),
    anchors: undefined,
    recvMode: undefined,
  }),
...
export default function RotationBoard() {
  ...
  const [renameSet, setRenameSet] = useState(null);
  ...
  // 戰報範圍：空陣列＝全部已存場次；-1 代表記錄中的這一局；其餘是 sets 的索引
  ...
  const [anchorMode, setAnchorMode] = useState(null); // 定點頁在編哪一組定點（不影響 team.mode）
  ...
  const setTweak = (r, scene, pos, xy) =>
    patchTeam((t) => ({ ...t, tweaks: { ...(t.tweaks || {}), [tweakKey(r, scene, pos)]: xy } }));
  const clearTweaks = (r, scene) =>
    patchTeam((t) => {
      const next = { ...(t.tweaks || {}) };
      [1, 2, 3, 4, 5, 6].forEach((q) => delete next[tweakKey(r, scene, q)]);
      return { ...t, tweaks: next };
    });
  const hasTweak = (r, scene) => [1, 2, 3, 4, 5, 6].some((q) => tweaks[tweakKey(r, scene, q)]);
  ...
  useEffect(() => {
    ...
    const t = setTimeout(() => {
      try {
        store.set(STORAGE_KEY, JSON.stringify({ v: STORAGE_V, teams, activeId, match, sets })).catch(() => {});
      } catch { /* 儲存失敗不影響操作 */ }
    }, 900);
    return () => clearTimeout(t);
  }, [teams, activeId, match, sets]);
  const save = async () => {
    setSaveState("saving");
    try {
      const r = await store.set(STORAGE_KEY, JSON.stringify({ v: STORAGE_V, teams, activeId, match, sets }));
  ...
  const clearSaved = async () => {
    ...
    setTeams(DEFAULT_TEAMS); setActiveId(null);
  };
  ...
  const mForm = (scene) => (mReady ? form(mLineup, match.rot, scene, match.serving, match.ovBack) : { ok: false, reason: "名單有異動" });
  ...
  const exportPng = () => {
    ...
    setTimeout(() => {
      try {
        ...
        txt("排球輪轉表", PAD, PAD + 15, { size: 15, weight: 800, align: "left" });
  ...
  /* 定點頁的模式：只決定「要編哪一組定點」，不會動到 team.mode／court／roster。
     預設跟著隊伍模式；隊伍還沒選模式就用第一個 */
  const aMode = (anchorMode && PRESETS[anchorMode]) ? anchorMode
    : (teamMode && PRESETS[teamMode]) ? teamMode : MODE_KEYS[0];
  const switchAnchorMode = (m) => {
    setAnchorMode(m);
    const keys = anchorSetKeys(m, recvMode);
    setEditKey((k) => (keys.includes(k) ? k : keys[0])); // 這一套在新模式沒有就跳回第一套
  };
  const RECV_POS = MODE_RECV_POS[aMode] || [2, 3, 4];
  const DEF_LABEL = [["L", "副攻攻擊"], ["C", "中間攻擊"], ["R", "大砲攻擊"]];
  const EDIT_SETS = [
    ...RECV_POS.map((q) => ({
      key: `recv.${recvMode}.P${q}`,
      label: `舉球在${q}號位`,
      get: (A) => (A.recv[recvMode] || A.recv.R5)["P" + q],
      ball: null,
      grp: "接發",
    })),
  ...
  const EDIT_ROWS = EDIT_SETS.reduce((rows, st) => {
    const row = rows.find(([g]) => g === st.grp);
    if (row) row[1].push(st); else rows.push([st.grp, [st]]);
    return rows;
  }, []);
  ...
  const VALID_KEYS = isRecv
    ? ["1", "2", "3", "4", "5", "6"]
    : ["FL", "FC", "FR", "BL", "BC", "BR"];
  // 接發的點顯示位置（舉／砲／中／背）而不是號位數字，依定點頁選到的模式算
  const recvLab = isRecv ? recvZoneLabels(aMode, Number(curKey.slice(-1))) : null;
  ...
  return (
    <div onClick={() => setSelZone(null)}
      ...
      <div className="flex items-baseline justify-between mb-2 no-print">
        <div>
          <div style={{ fontSize: 19, fontWeight: 800 }}>排球輪轉板</div>
      ...
      {team && tab === "setup" && (
        <div style={card}>
          ...
          <div style={{ fontSize: 10.5, color: C.muted, marginTop: 4, lineHeight: 1.8 }}>
            {backMode === "def" && backRuleText(teamMode)}
                ...
                return (
                  <div>
                    ...
                    {isDef && (() => {
                      const base = mForm("d2");
                      const front = base.ok
                        ? FRONT_SLOTS.map((k) => base.spots.find((q) => q.slot === k)).filter(Boolean)
                        : [];
                      // 三個攻擊方向裡，只要有一套把他放到網線上，就是攔網球員
                      const netIds = new Set();
                      ["d3", "d2", "d1"].forEach((sc) => {
                        const f = mForm(sc);
                        if (!f.ok) return;
                        f.spots.forEach((q) => {
                          if (FRONT_SLOTS.includes(q.slot) && q.xy[1] <= NET_TOUCH) netIds.add(q.e.id);
                        });
                      });
                        ...
                        <div style={{
                          ...
                          <div className="flex items-center gap-1 flex-wrap" style={{ marginBottom: 6 }}>
                            ...
                            {front.map((f) => {
                              ...
                              // 沒有人被放到網線上時就不淡化，免得整排都變灰
                              const isBlocker = netIds.size === 0 || netIds.has(f.e.id);
                              return (
      ...
      {team && tab === "match" && mView === "report" && (() => {
        ...
        const pool = [...live, ...mine];
        const use = picked.length ? pool.filter((x) => picked.includes(x._i)) : mine;
        const multi = use.length > 1;
        // 帶上該場的起始時間，逐球回顧才算得出「第幾分幾秒」
        const rallies = use.flatMap((x) =>
          x.rallies.map((ra, j) => ({
            ...ra, _base: x.startedAt || null, _set: x._i, _ri: j,
            _name: x.name || (x.at ? new Date(x.at).toLocaleDateString("zh-TW") : "記錄中"),
          })));
        const assignBlock = (setIdx, ri, pid) => {
          if (setIdx === -1) {
            setMatch((mm) => ({ ...mm, rallies: mm.rallies.map((ra, i) => (i === ri ? { ...ra, blockBy: pid } : ra)) }));
          } else {
            setSets((S) => S.map((x, i) => (i === setIdx
              ? { ...x, rallies: x.rallies.map((ra, j) => (j === ri ? { ...ra, blockBy: pid } : ra)) } : x)));
          }
        };
        ...
        const formFor = (sc) => (full ? form(lineup, 0, sc) : { ok: false });
                  ...
                  {blameOf(rallies, k).length === 0 ? (
                    ...
                    return (
                      <div key={id}>
                        ...
                        {bOpen && (
                          <div style={{ margin: "0 0 4px 12px", color: C.muted, fontSize: 10.5 }}>
                            {list.map((o) => (
                              <div key={o.i} style={{ marginBottom: NO_BLAME.includes(k) && id === "__none" ? 5 : 0 }}>
                                <span style={{ fontFamily: MONO }}>
                                  {o.us}:{o.them}　R{o.rot + 1}
                                  {o.at && o.base ? `　${clock(o.at - o.base)}` : ""}
                                </span>
                                {NO_BLAME.includes(k) && id === "__none" && (
                                  <span className="flex gap-1 flex-wrap" style={{ marginTop: 2 }}>
                                    <span style={{ fontSize: 10, alignSelf: "center" }}>補記：</span>
                                    {court.filter(Boolean).map((pidv) => (
                                      <button key={pidv} onClick={() => assignBlock(o.setIdx, o.ri, pidv)}
                                        style={{ ...btn, padding: "2px 7px", fontSize: 10.5 }}>
                                        {byId[pidv] ? byId[pidv].name || "？" : "？"}
                                      </button>
                                    ))}
                                  </span>
                                )}
        ...
        return (
          <div>
            <div className="flex gap-1 mb-2 flex-wrap items-center">
              <button onClick={() => togglePick(-1)} disabled={!live.length}
                style={{ ...btn, fontSize: 11, padding: "5px 9px", opacity: live.length ? 1 : 0.4,
                  background: picked.includes(-1) ? C.ink : C.panel, color: picked.includes(-1) ? C.paper : C.ink }}>
                記錄中
              </button>
              <button onClick={() => setPicked([])}
                style={{ ...btn, fontSize: 11, padding: "5px 9px",
                  background: picked.length ? C.panel : C.ink, color: picked.length ? C.ink : C.paper }}>
                全部 {mine.length} 場
              </button>
              <span style={{ fontSize: 11, color: C.muted, marginLeft: 4 }}>
                {picked.length
                  ? `已選 ${use.length} 場：${use.map((x) => x.name || "未命名").join("、")}`
                  : "下方可複選要合併的場次"}
              </span>
            </div>
            ...
            {mine.length > 0 && (
              <div style={{ ...card, marginBottom: 8, padding: 10 }}>
                <div style={{ fontSize: 12, fontWeight: 800, marginBottom: 2 }}>已存場次</div>
                <div style={{ fontSize: 10.5, color: C.muted, marginBottom: 4 }}>
                  點一下勾選（可複選，合併計算），點兩下改名
                </div>
                {mine.slice().reverse().map((x) => (
                  <div key={x._i} className="flex items-center gap-2" style={{ padding: "3px 0", borderTop: `1px solid ${C.edge}` }}>
                    {renameSet === x._i ? (
                      <input autoFocus value={x.name || ""}
                        onChange={(ev) => setSets((S) => S.map((y, i) => (i === x._i ? { ...y, name: ev.target.value } : y)))}
                        onBlur={() => setRenameSet(null)}
                        onKeyDown={(ev) => (ev.key === "Enter" || ev.key === "Escape") && setRenameSet(null)}
                        placeholder="比賽名稱"
                        style={{
                          flex: 1, fontFamily: FONT, fontSize: 12, fontWeight: 700, padding: "5px 8px",
                          borderRadius: 8, border: `1px solid ${C.ink}`, background: "#fff", color: C.ink,
                        }} />
                    ) : (
                      <button onClick={() => togglePick(x._i)}
                        onDoubleClick={() => setRenameSet(x._i)}
                        style={{
                          ...btn, flex: 1, textAlign: "left", padding: "4px 8px", fontSize: 11.5,
                          background: picked.includes(x._i) ? C.ink : C.panel,
                          color: picked.includes(x._i) ? C.paper : C.ink,
                        }}>
                        <span style={{ marginRight: 5, opacity: 0.8 }}>{picked.includes(x._i) ? "☑" : "☐"}</span>
            ...
            {rallies.length === 0 ? (
              ...
              <>
                <div style={{ ...card, marginBottom: 8 }}>
                  ...
                  <div className="flex items-center gap-2" style={{ marginTop: 4, fontSize: 11.5, color: C.muted }}>
                    <span style={{ width: 64 }}>攔網觸球</span>
                    <span style={{ flex: 1 }} />
                    <span style={{ fontFamily: MONO, width: 46, textAlign: "right" }}>{st.touches}</span>
                  </div>
                  <div style={{ height: 6 }} />
                      ...
                      return (
                        <div key={i} style={{ borderTop: i ? `1px solid ${C.edge}` : "none" }}>
                          <div className="flex items-center gap-2"
                            ...
                            {multi && (
                              <span style={{ width: 58, color: C.muted, fontSize: 10, overflow: "hidden", whiteSpace: "nowrap" }}>
                                {ra._name}
                              </span>
                            )}
      ...
      {team && tab === "sheet" && (
        ...
        <div style={{ overflowX: "auto", WebkitOverflowScrolling: "touch" }}>
          <div className="print-title" style={{ fontSize: 16, fontWeight: 800, marginBottom: 6 }}>排球輪轉表</div>
                      ...
                      <div style={{ position: "relative" }}>
                        ...
                        {hasTweak(r, s.id) && (
                          <span style={{
                            ...
                            color: C.paper, background: C.blue, borderRadius: 4, padding: "0 4px",
                          }}>調</span>
                        )}
                      </div>
                    </button>
      ...
      {team && tab === "anchor" && (
        <div style={card}>
          <div className="flex items-baseline gap-2 flex-wrap" style={{ marginBottom: 6 }}>
            <span style={{ fontSize: 16, fontWeight: 800 }}>{team.name || "未命名"}</span>
            <span style={{ fontSize: 11, color: C.muted }}>的定點</span>
            {teams.length > 1 && (
              <select value="" onChange={(e) => { if (e.target.value) copyAnchorsFrom(e.target.value); }}
                style={{
                  marginLeft: "auto", fontFamily: FONT, fontSize: 11, padding: "5px 6px",
                  borderRadius: 8, border: `1px solid ${C.edge}`, background: C.panel, color: C.ink,
                }}>
                <option value="">複製其他隊的定點…</option>
          ...
          <div style={{ fontSize: 12, color: C.muted, marginBottom: 8 }}>
            拖動任一個點，全部輪轉同步更新，並自動儲存。這些定點<b>只屬於這一隊</b>，改動不影響其他隊伍。
          </div>
          ...
          <div className="flex items-center gap-1 mb-2 flex-wrap">
            ...
            <span style={{ fontSize: 10.5, color: C.muted, marginLeft: 4 }}>只是挑要編哪一套，不會改到隊伍設定</span>
          </div>
          {/* 第二行：接發人數（全圖也跟著換） */}
          <div className="flex items-center gap-1 mb-2 flex-wrap">
          ...
          <div style={{ display: "flex", gap: 16, alignItems: "flex-start", flexWrap: "wrap", justifyContent: "center" }}>
            ...
            <div style={{
              ...
              <div style={{ fontSize: 10.5, color: C.muted, marginTop: 2, marginBottom: 8 }}>
                {/* 接發那幾套跟著上面選到的模式，防守那幾套只標自己的套別 */}
                {aMode}・{DEF_VAR_NAME[defVar] ? `${DEF_VAR_NAME[defVar]}・` : ""}{cur.label}
              </div>
              {recvLab ? (
                <>
          ...
          <div style={{ fontSize: 11, color: C.muted, marginTop: 8, lineHeight: 1.7 }}>
            上面「模式」只是挑要編哪一組定點，第三、四行就是該模式真正用得到的套別。
            接發每種人數各一套；4人接發把不接的那兩位拖到網前即可，
            <b>3人接發目前只排開舉球與副攻，還剩 4 人在接</b>，第三個不接發的人請自行拖走。
            防守前排三點：砲中＝砲・中・<b>舉</b>；砲背＝砲・<b>舉</b>・背；砲中背＝砲・中・背（由左至右）；
            後排點按照基本輪轉順序，除非適用特殊規則。
            前排的點只要碰到網線就算那一套的攔網球員。
          </div>
          <div className="flex gap-2 mt-2">
            <button onClick={() => setAnchors(JSON.parse(JSON.stringify(DEFAULT_ANCHORS)))} style={btn}>
              還原預設（只影響這一隊）
            </button>
          </div>
          <pre style={{
            ...
            {pngUrl === "error" ? (
              ...
              <>
                <div className="flex items-center justify-between mb-2 gap-2">
                  ...
                  <div className="flex gap-1">
                    <a href={pngUrl} download="排球輪轉表.png"
      ...
      {/* 放大 */}
      {zoom && (() => {
        const fm = form(lineup, zoom.r, zoom.scene.id);
            ...
            <div style={{ ...card, padding: 16 }} onClick={(e) => e.stopPropagation()}>
              ...
              {fm.ok && (
                <div onPointerMove={(ev) => {
                    if (!zDrag || !zRef.current) return;
                    const rect = zRef.current.getBoundingClientRect();
                    const x = ((ev.clientX - rect.left) / rect.width);
                    const y = ((((ev.clientY - rect.top) / rect.height) * VB_H) - 30) / 100;
                    setTweak(zoom.r, zoom.scene.id, zDrag, [
                      +Math.max(0.04, Math.min(0.96, x)).toFixed(3),
                      +Math.max(-0.2, Math.min(1.15, y)).toFixed(3),
                    ]);
                  }}
              ...
              <div className="flex items-center gap-2" style={{ marginTop: 6 }}>
                <span style={{ fontSize: 11, color: C.muted }}>
                  拖動球員可微調這一格的站位，只影響這一輪這一張圖
                </span>
                {hasTweak(zoom.r, zoom.scene.id) && (
                  <button onClick={() => clearTweaks(zoom.r, zoom.scene.id)}
                    style={{ ...btn, padding: "3px 8px", fontSize: 11, marginLeft: "auto", color: C.warn }}>
                    還原這張
                  </button>
                )}
              </div>
