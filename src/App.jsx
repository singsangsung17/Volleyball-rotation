...
const DEFAULT_ANCHORS = {
  ...
  // 每種人數再依舉球站的號位分 P1–P6（P1／P5／P6 是舉球在後排，只有單舉會輪到）
  recv: {
    R5: { // 5 人接發
      P1: { 1: [0.8, 0.3], 2: [0.85, 0.12], 3: [0.5, 0.1], 4: [0.18, 0.06], 5: [0.2, 0.72], 6: [0.5, 0.8] },
      ...
      P4: { 1: [0.725, 0.822], 2: [0.869, 0.401], 3: [0.152, 0.413], 4: [0.106, 0.099], 5: [0.266, 0.81], 6: [0.491, 0.625] },
      P5: { 1: [0.82, 0.7], 2: [0.85, 0.06], 3: [0.5, 0.1], 4: [0.18, 0.12], 5: [0.12, 0.3], 6: [0.5, 0.8] },
      P6: { 1: [0.82, 0.7], 2: [0.85, 0.12], 3: [0.5, 0.06], 4: [0.18, 0.12], 5: [0.2, 0.72], 6: [0.5, 0.2] },
    },
    R4: { // 4 人接發（不接的兩位拉到網前）
      P1: { 1: [0.8, 0.3], 2: [0.85, 0.12], 3: [0.5, 0.1], 4: [0.18, 0.06], 5: [0.2, 0.72], 6: [0.5, 0.8] },
      P2: { 1: [0.847, 0.549], 2: [0.885, 0.135], 3: [0.177, 0.515], 4: [0.051, 0.129], 5: [0.348, 0.795], 6: [0.673, 0.795] },
      P3: { 1: [0.837, 0.471], 2: [0.594, 0.224], 3: [0.499, 0.112], 4: [0.14, 0.433], 5: [0.341, 0.785], 6: [0.714, 0.768] },
      P4: { 1: [0.8, 0.597], 2: [0.212, 0.545], 3: [0.071, 0.286], 4: [0.054, 0.091], 5: [0.382, 0.816], 6: [0.64, 0.822] },
      P5: { 1: [0.82, 0.7], 2: [0.85, 0.06], 3: [0.5, 0.1], 4: [0.18, 0.12], 5: [0.12, 0.3], 6: [0.5, 0.8] },
      P6: { 1: [0.82, 0.7], 2: [0.85, 0.12], 3: [0.5, 0.06], 4: [0.18, 0.12], 5: [0.2, 0.72], 6: [0.5, 0.2] },
    },
    R3: { // 3 人接發：舉球與副攻已拉開不接，第三個不接的人由使用者自行拖走
      P1: { 1: [0.902, 0.698], 2: [0.797, 0.547], 3: [0.477, 0.15], 4: [0.172, 0.144], 5: [0.191, 0.642], 6: [0.523, 0.762] },
      P2: { 1: [0.88, 0.584], 2: [0.885, 0.135], 3: [0.169, 0.642], 4: [0.051, 0.129], 5: [0.348, 0.93], 6: [0.538, 0.661] },
      P3: { 1: [0.862, 0.652], 2: [0.594, 0.224], 3: [0.499, 0.112], 4: [0.182, 0.575], 5: [0.535, 0.716], 6: [0.714, 0.93] },
      P4: { 1: [0.935, 0.87], 2: [0.188, 0.596], 3: [0.109, 0.256], 4: [0.075, 0.078], 5: [0.508, 0.713], 6: [0.84, 0.658] },
